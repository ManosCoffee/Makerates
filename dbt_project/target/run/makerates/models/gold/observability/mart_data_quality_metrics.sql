    ...
    create  table
      "gold"."main_gold"."mart_data_quality_metrics__dbt_tmp"
...
validation_stats AS (
    ...
    FROM "gold"."main_silver"."fact_rates_validated"
    WHERE rate_date = (SELECT MAX(rate_date) FROM "gold"."main_silver"."fact_rates_validated")
),
...
consensus_stats AS (
    ...
    FROM "gold"."main_silver"."consensus_check"
    WHERE status = 'FLAGGED'
      AND rate_date = (SELECT MAX(rate_date) FROM "gold"."main_silver"."fact_rates_validated")
)
