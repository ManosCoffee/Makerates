  ...
  create view "gold"."main_silver"."stg_currencylayer__dbt_tmp" as (
...
WITH bronze_data AS (
    ...
    SELECT *
    FROM iceberg_scan('s3://silver-bucket/iceberg/currencylayer_rates/metadata/00003-861fa448-284d-4e7e-bc6a-6e4de36ae678.metadata.json')
