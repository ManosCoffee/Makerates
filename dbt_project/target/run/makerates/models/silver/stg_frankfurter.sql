  ...
  create view "gold"."main_silver"."stg_frankfurter__dbt_tmp" as (
...
WITH bronze_data AS (
    -- Read from Silver Iceberg Table (Compacted & Deduplicated)
    SELECT *
    FROM iceberg_scan('s3://silver-bucket/iceberg/frankfurter_rates/metadata/00010-1e233efe-ffcd-42e7-ac92-53bb564f744a.metadata.json')
